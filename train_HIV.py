...
def processUnit(iMol,start,i,batch_size,count,tracker,adj_len,full_size):
    ...
    while(rdkit.Chem.rdmolfiles.MolFromSmiles(tmp)==None and len(tmp)!=0):
        ...
        if(full_size>=3):
            ...
            fig = Draw.MolToFile(iMol, "./amesfirstmodImg3/" + str(i * batch_size + count) + '.png', size=size,
...
def training(model, FLAGS, model_name, smi_total, prop_total):
    ...
    stuff = open("C:/Users/Zac Hung/Desktop/masterthesis/experiment/amessept1smilesData2.txt", 'w')
    stuff1 = open("C:/Users/Zac Hung/Desktop/masterthesis/experiment/firstmd.txt", 'w')
    stuff2 = open("C:/Users/Zac Hung/Desktop/masterthesis/experiment/tmaleat.txt", 'w')
    stuff3 = open("C:/Users/Zac Hung/Desktop/masterthesis/experiment/tmepist.txt", 'w')
    ...
    total_st = time.time()
    smi_train, smi_eval, smi_test = split_train_eval_test(smi_total, 0, 0.2, 0)
    prop_train, prop_eval, prop_test = split_train_eval_test(prop_total, 0, 0.2, 0)
