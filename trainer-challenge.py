...
def main():
    ...
    parser.add_argument('--output', '-o', required=False, help='PATH to output')
    parser.add_argument('--input', '-i', required=True, help='PATH to TOX21 data')
    parser.add_argument('--atomsize', '-a', type=int, default=550,
    ...
    END = time.time()
    print('Nice, your Learning Job is done.縲Total time is {} sec��'.format(END - START))
